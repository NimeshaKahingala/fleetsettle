...
**Status:** v1.2.5 — §9.1 re-phased: write-offs, post-closure charges, the year, ageing, utilisation and export (UC-73, 77, 78, 79, 90, 91, 99) move from Second to First, on the owner's 11 Aug 2026 phase-1-covers-everything decision. Full reasoning in TRACKER.md's "phase model" section
**Date:** 11 August 2026
...
| **W-11** | Insurance is claimed **only for major damage**. | The claim section is optional and off by default. A claim in progress is money expected, not money earned, and must be visible as pending for the months before it arrives. UC-12 |
...
**4. Insurance, only if it is worth claiming (W-11).** The section stays hidden unless you turn it on. When you do: amount claimed, the excess you bear, status, and the amount actually received. Until it arrives it is **money expected, not money earned** — visible as a pending recovery, never inside the month's profit.
...
*Sees:* owner, owner-manager, manager for shared vehicles.
...
**UC-96 Fix something entered wrongly** *(W-50)*
