...
**Status:** v1.2.20 — **P14 messaging specified for build, 13 Sept 2026: W-14 revisited on evidence and reaffirmed; W-71, W-72 and W-73 added ⚑.** §8 recorded W-14 as a decision to attack, and the 17 Aug deferral waited for real use to attack it with. Real use exists now, and the owner's answers settled it for automatic sending over the Cloud API with business verification deferred — chiefly because delivered and read status is wanted, and no assisted path can produce it. Three mechanics Group I required without saying how to keep become decisions: **W-71**, verification before money is a *hold* released by an amount-free message to that exact number, never a drop; **W-72**, an attempt that may have reached the recipient is never resent automatically; **W-73**, a payment reversal re-arms reminders as a new round and stops the old one. The prerequisites table is corrected against Meta's own documentation — the 250 limit counts unique recipients across the portfolio, unverified accounts hold 250 templates, and the template count was never twelve. Mechanics: `user-flows.md` v1.1.22; schema: `data-model.md` v1.1.21 §11.1; reasoning and sequencing: `docs/evaluations/P14-MESSAGING-PLAN-2026-09-13.md`. No golden-fixture figure moves.
...
### Provenance of W-71 to W-73, and what the P14 plan declined

These three came from sizing P14 for build (`docs/evaluations/P14-MESSAGING-PLAN-2026-09-13.md`), after two independent validation passes against the code and against Meta's and Cloudflare's own documentation — recorded here for the same reason as W-27 to W-36 and W-63 to W-67. All three make explicit something Group I already required but had not said how to keep; none changes what a customer or driver is told, except that a receipt correction now arrives at once.
