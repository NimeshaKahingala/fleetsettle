...
**Status:** v1.2.6 — §9.1 gains incidents (UC-12), the omission behind TRACKER.md's own standing open question (a golden fixture, G-2, with no owning phase); W-11 drops "the claim section is optional and off by default" — the "off by default" half was never backed by a settings field (GAP-11), so the claim action is always offered and the choice not to file one is the manager's judgement, not a switch. Both decided by the owner, 11 Aug 2026
**Date:** 11 August 2026
