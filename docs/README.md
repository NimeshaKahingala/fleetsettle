...
| 6 | [design/ui-ux-guidelines.md](design/ui-ux-guidelines.md) | **Surface.** The mobile-first design system, `M-1…M-29`, components, per-flow screen specs, the React client | Behaviour — it renders §1 and §2 |
