...
1. **Both fixed, 13 September 2026** ([Plan.md](../../Plan.md) Wave 8d): **GAP-229, PR #192** — P14's correction messages read the credit `correctPayment` now computes. **GAP-230, PR #193** — P14's deposit-release messages follow the new `POST /api/deposit/{id}/release` operation.
