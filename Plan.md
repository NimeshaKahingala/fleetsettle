...
>
> **What is left, in one line:** three open gaps (GAP-135, GAP-65/A14, GAP-18 — **GAP-131 and GAP-132 closed 16 Aug 2026**), Wave 8's four live-test items (LT-9, LT-10, LT-12, LT-13), [Wave 8b · document dispositions](#wave-8b--document-dispositions-s--added-16-august-2026), then Wave 9 · Release — and after phase 1, [Wave 10 · P14 messaging](#wave-10--p14-messaging--phase-2-unsized-and-that-is-the-finding) and [Wave 11 · B7 offline/PWA](#wave-11--b7-offline-and-the-pwa--phase-3).
>
> **LT-13 is the one to run first.** It is the phase-1 mobile interaction sweep, it has found a real defect on every pass — GAP-125, then GAP-134 — and it is nowhere near finished.
...
**Do first, independent of sequencing:** fire the twelve approvals now. They queue, they cost nothing to start, and they are the only remaining work in the project with a clock someone else controls.
