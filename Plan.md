...
| 13 | **B9** · the remaining UI fixes | M | **GAP-44 and GAP-89 decided 10 Aug** (TRACKER.md carries the reasoning) — the batch is now fully unblocked. Twelve items total: GAP-44/45/46/47/48/55/83/89/91/96/97/99, plus GAP-105/106 from the 10 Aug live pass. None built yet |
